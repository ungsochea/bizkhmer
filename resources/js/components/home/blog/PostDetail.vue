    ...
    <div class="page-title">
		<div class="container">
			<div class="row">
				<div class="col-sm-12">
					<ol class="breadcrumb">
     					<li><router-link tag="a" to="/">ទំព័រដើម</router-link>
     					<li><a>{{this.category}}</a></li>
     				</ol>
				</div><!-- Col end -->
			</div><!-- Row end -->
		</div><!-- Container end -->
            ...
            <div class="single-post">
						...
						<div class="post-content-area">
							<div class="entry-content">
								...
								<p><img class="pull-left" src="/assets/images/news/news-details/news-details2.jpg" alt=""></p>
...
export default {
    ...
    methods:{
        cat_title(){
            axios.get(`/api/category-name/${this.$route.params.category}`)
